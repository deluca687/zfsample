...
class PostTableTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCanRetrieveAnPostByItsId()
    {
        $post = new Post();
        $post->exchangeArray(array('id'     => 123,
                                    'content' => 'The Military Wives',
                                    'title'  => 'In My Dreams'));
    ...
    public function testCanDeleteAnPostByItsId()
    {
    ...
    {
        $postData = array('content' => 'The Military Wives', 'title' => 'In My Dreams');
        $post     = new Post();
    ...
    {
        $postData = array('id' => 123, 'content' => 'The Military Wives', 'title' => 'In My Dreams');
        $post     = new Post();
        $post->exchangeArray($postData);
        ...
        $mockTableGateway->expects($this->once())
                         ->method('update')
                         ->with(array('content' => 'The Military Wives', 'title' => 'In My Dreams'),
                                array('id' => 123));
